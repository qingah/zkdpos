...
pub struct AddLiquidity {
    ...
    /// Address of account to add liquidity funds from.
    pub from: Address,
    /// Address of account to add liquidity funds to.
    pub to: Address,
    /// Type of token for add liquidity. Also represents the token in which fee will be paid.
    pub token: TokenId,
    /// Amount of funds to add liquidity.
