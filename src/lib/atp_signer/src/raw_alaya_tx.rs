...
use zkdpos_types::{H160, U256};

/// Description of a Transaction, pending or in the chain.
#[derive(Debug, Default, Clone, PartialEq, Deserialize, Serialize)]
pub struct RawTransaction {
    /// Chain id: mainnet => 201018, testnet => 201030, etc.
    pub chain_id: u32,
    /// Nonce
    pub nonce: U256,
...
impl RawTransaction {
    ...
    pub fn hash(&self) -> [u8; 32] {
        ...
        // hash.append(&vec![(self.chain_id as u8)]);
...
// (sig: Signature, chain_id: u32)

fn to_ecdsa(sig: Signature) -> EcdsaSig {
    EcdsaSig {
        v: vec![sig.v() as u8], // vec![sig.v() as u8 + (chain_id * 2 + 35) as u8],
        r: sig.r().to_vec(),
        s: sig.s().to_vec(),
    }
}
