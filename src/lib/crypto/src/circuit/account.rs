...
/// Account tree used in the `zkdpos_circuit`.
pub type CircuitAccountTree = SparseMerkleTree<CircuitAccount<Bn256>, Fr, RescueHasher<Bn256>>;
/// Balance tree for accounts used in the `zkdpos_circuit`.
...
/// Representation of the zkDpos account used in the `zkdpos_circuit`.
#[derive(Clone)]
...
/// Representation of one token balance used in `zkdpos_circuit`.
#[derive(Clone, Debug)]
