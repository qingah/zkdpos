...
use web3::types::H160;
use zkdpos_types::{AccountId, AccountUpdate, Nonce, SignedZkDposTx, TokenId, Transfer, ZkDposTx};
...
fn execute_txs_batch_success_transfers() {
    ...
    let signed_zk_sync_tx_bad = SignedZkDposTx {
        tx: ZkDposTx::Transfer(Box::new(transfer_bad)),
        atp_sign_data: None,
    };
