...
use zkdpos_crypto::{
    ...
    params::{
        ...
        ATP_ADDRESS_BIT_WIDTH, NEW_PUBKEY_HASH_WIDTH, NONCE_BIT_WIDTH, TOKEN_BIT_WIDTH,
        TX_TYPE_BIT_WIDTH,
    },
};
use zkdpos_types::operations::DepositOp;
// Local deps
use crate::{
    operation::{
...
impl Witness for DepositWitness<Bn256> {
    ...
    fn apply_tx(tree: &mut CircuitAccountTree, deposit: &DepositOp) -> Self {
        let deposit_data = DepositData {
            ...
            address: atp_address_to_fr(&deposit.priority_op.to),
        };
    ...
    fn apply_data(tree: &mut CircuitAccountTree, deposit: &DepositData) -> Self {
        ...
        DepositWitness {
            ...
            args: OperationArguments {
                atp_address: Some(deposit.address),
