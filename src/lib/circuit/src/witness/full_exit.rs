...
use zkdpos_crypto::{
    ...
    params::{
        ...
        ATP_ADDRESS_BIT_WIDTH, TOKEN_BIT_WIDTH, TX_TYPE_BIT_WIDTH,
    },
};
use zkdpos_types::FullExitOp;
// Local deps
use crate::{
    operation::{
...
impl Witness for FullExitWitness<Bn256> {
    ...
    fn apply_tx(
        ...
        let full_exit = FullExitData {
            ...
            atp_address: atp_address_to_fr(&full_exit.priority_op.atp_address),
    ...
    fn apply_data(
        ...
        FullExitWitness {
            ...
            args: OperationArguments {
                atp_address: Some(full_exit.atp_address),
