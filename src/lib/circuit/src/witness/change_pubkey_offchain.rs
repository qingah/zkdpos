...
use zkdpos_crypto::{
    ...
    params::{
        account_tree_depth, ACCOUNT_ID_BIT_WIDTH, CHUNK_BIT_WIDTH, ATP_ADDRESS_BIT_WIDTH,
...
impl Witness for ChangePubkeyOffChainWitness<Bn256> {
    ...
    fn apply_tx(tree: &mut CircuitAccountTree, change_pubkey_offchain: &ChangePubKeyOp) -> Self {
        ...
        let change_pubkey_data = ChangePubkeyOffChainData {
            ...
            address: atp_address_to_fr(&change_pubkey_offchain.tx.account),
    ...
    fn apply_data(
        ...
        ChangePubkeyOffChainWitness {
            ...
            args: OperationArguments {
                atp_address: Some(change_pubkey_offcahin.address),
