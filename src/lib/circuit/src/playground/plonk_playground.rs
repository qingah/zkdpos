...
use crate::witness::tests::test_utils::{WitnessTestAccount, ZkDposStateGenerator};
use crate::witness::utils::WitnessBuilder;
use crate::witness::{deposit::DepositWitness, Witness};
use num::BigUint;
use rayon::prelude::*;
use std::time::Instant;
use zkdpos_crypto::Fr;
use zkdpos_types::prover_utils::fs_utils::{
    get_universal_setup_lagrange_form, get_universal_setup_monomial_form,
};
use zkdpos_types::{Deposit, DepositOp};
...
fn test_transpile_deposit_franklin_existing_account() {
    ...
    let (mut plasma_state, mut circuit_account_tree) =
        ZkDposStateGenerator::generate(&vec![account]);
    ...
    use zkdpos_crypto::franklin_crypto::bellman::pairing::bn256::Bn256;
    use zkdpos_crypto::franklin_crypto::bellman::plonk::adaptor::alternative::*;
    use zkdpos_crypto::franklin_crypto::bellman::plonk::plonk::generator::*;
    use zkdpos_crypto::franklin_crypto::bellman::plonk::plonk::prover::*;
    use zkdpos_crypto::franklin_crypto::bellman::Circuit;
    ...
    use zkdpos_crypto::franklin_crypto::bellman::plonk::cs::Circuit as PlonkCircuit;
...
fn test_new_transpile_deposit_franklin_existing_account_validate_only() {
    ...
    let deposit_to_account_id = account.id;
    let deposit_to_account_address = account.account.address;
    let (mut plasma_state, mut circuit_tree) = ZkDposStateGenerator::generate(&vec![account]);
    ...
    use zkdpos_crypto::franklin_crypto::bellman::pairing::bn256::Bn256;
    use zkdpos_crypto::franklin_crypto::bellman::plonk::better_cs::adaptor::*;
    use zkdpos_crypto::franklin_crypto::bellman::plonk::*;
    ...
    use zkdpos_crypto::franklin_crypto::bellman::plonk::better_cs::adaptor::TranspilationVariant;
...
fn test_new_transpile_deposit_franklin_existing_account() {
    ...
    use zkdpos_crypto::franklin_crypto::bellman::pairing::bn256::Bn256;
    use zkdpos_crypto::franklin_crypto::bellman::plonk::commitments::transcript::keccak_transcript::RollingKeccakTranscript;
    use zkdpos_crypto::franklin_crypto::bellman::plonk::*;
    ...
    use zkdpos_crypto::franklin_crypto::bellman::plonk::fft::cooley_tukey_ntt::*;
...
fn test_fma_transpile_deposit_franklin_existing_account() {
    ...
    use zkdpos_crypto::franklin_crypto::bellman::pairing::bn256::Bn256;
    use zkdpos_crypto::franklin_crypto::bellman::plonk::better_cs::cs::PlonkCsWidth4WithNextStepParams;
    use zkdpos_crypto::franklin_crypto::bellman::plonk::better_cs::fma_adaptor::Transpiler;
    ...
    use zkdpos_crypto::franklin_crypto::bellman::plonk::better_cs::fma_adaptor::TranspilationVariant;
...
fn print_available_setup_powers() {
    ...
    let calculate_setup_power = |chunks: usize| -> (usize, u32) {
        let circuit = {
            let (_, mut circuit_account_tree) = ZkDposStateGenerator::generate(&[]);
