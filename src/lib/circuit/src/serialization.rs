...
// Workspace
use zkdpos_crypto::ff::PrimeField;
use zkdpos_crypto::franklin_crypto::alt_babyjubjub::AltJubjubBn256;
use zkdpos_crypto::franklin_crypto::rescue::bn256::Bn256RescueParams;
use zkdpos_crypto::serialization::*;
use zkdpos_crypto::{Engine, Fr};
// Local
use crate::account::AccountWitness;
use crate::circuit::ZkDposCircuit;
use crate::operation::{
...
impl ProverData {
    pub fn into_circuit(self) -> ZkDposCircuit<'static, Engine> {
        ZkDposCircuit {
            rescue_params: &zkdpos_crypto::params::RESCUE_PARAMS as &Bn256RescueParams,
            jubjub_params: &zkdpos_crypto::params::JUBJUB_PARAMS as &AltJubjubBn256,
